...
public class LuisEntity extends MoreToolsElements.ModElement {
	public static EntityType entity = null;
	public LuisEntity(MoreToolsElements instance) {
		super(instance, 95);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("luis")
						.setRegistryName("luis");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -65536, -6750004, new Item.Properties().group(AstroneerItemGroup.tab)).setRegistryName("luis"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("more_tools:sylvabiome")))
				biomeCriteria = true;
			if (!biomeCriteria)
				continue;
		...
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("more_tools:textures/pmcskin3d-steve-simple-12745693.png");
				}
			};
	...
	public static class CustomEntity extends ZombieEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Blocks.DEAD_BUSH, (int) (1)));
		}
