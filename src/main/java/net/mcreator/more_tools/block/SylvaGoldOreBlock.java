...
public class SylvaGoldOreBlock extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:sylvagoldore")
	public static final Block block = null;
	public SylvaGoldOreBlock(MoreToolsElements instance) {
		super(instance, 106);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SylvaGoldOreBlock.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("sylvagoldore", "sylvagoldore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == StoneSylvaBlock.block.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 3), Placement.COUNT_RANGE, new CountRangeConfig(9, 1, 1, 29)));
		}
	}
}
