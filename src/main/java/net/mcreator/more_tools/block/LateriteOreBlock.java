...
public class LateriteOreBlock extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:lateriteore")
	public static final Block block = null;
	public LateriteOreBlock(MoreToolsElements instance) {
		super(instance, 28);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("lateriteore", "lateriteore", blockAt -> {
