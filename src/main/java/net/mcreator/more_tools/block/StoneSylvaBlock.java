...
public class StoneSylvaBlock extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:stonesylva")
	public static final Block block = null;
	public StoneSylvaBlock(MoreToolsElements instance) {
		super(instance, 94);
	}
