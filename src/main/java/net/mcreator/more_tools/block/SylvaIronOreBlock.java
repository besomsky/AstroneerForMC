...
public class SylvaIronOreBlock extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:sylvaironore")
	public static final Block block = null;
	public SylvaIronOreBlock(MoreToolsElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SylvaIronOreBlock.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("sylvaironore", "sylvaironore", blockAt -> {
