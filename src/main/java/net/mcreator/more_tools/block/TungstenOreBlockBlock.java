...
public class TungstenOreBlockBlock extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:tungstenoreblock")
	public static final Block block = null;
	public TungstenOreBlockBlock(MoreToolsElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(6f, 10f).lightValue(0).harvestLevel(3)
