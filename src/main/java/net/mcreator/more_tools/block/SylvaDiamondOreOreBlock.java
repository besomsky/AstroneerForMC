...
public class SylvaDiamondOreOreBlock extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:sylvadiamondoreore")
	public static final Block block = null;
	public SylvaDiamondOreOreBlock(MoreToolsElements instance) {
		super(instance, 109);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sylvadiamondoreore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("sylvadiamondoreore", "sylvadiamondoreore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == StoneSylvaBlock.block.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 6), Placement.COUNT_RANGE, new CountRangeConfig(5, 1, 1, 15)));
		}
	}
}
