...
public class LateriteOreBlockBlock extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:lateriteoreblock")
	public static final Block block = null;
	public LateriteOreBlockBlock(MoreToolsElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lateriteoreblock");
		}
