...
public class SylvaEmeraldOreBlock extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:sylvaemeraldore")
	public static final Block block = null;
	public SylvaEmeraldOreBlock(MoreToolsElements instance) {
		super(instance, 115);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sylvaemeraldore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("sylvaemeraldore", "sylvaemeraldore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == StoneSylvaBlock.block.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 2), Placement.COUNT_RANGE, new CountRangeConfig(5, 1, 1, 32)));
		}
	}
}
