...
public class MalachiteOreBlock extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:malachiteore")
	public static final Block block = null;
	public MalachiteOreBlock(MoreToolsElements instance) {
		super(instance, 1);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("malachiteore", "malachiteore", blockAt -> {
