...
import net.mcreator.more_tools.procedures.OilMobplayerCollidesBlockProcedure;
...
public class OilBlock extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:oil")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("more_tools:oil_bucket")
	public static final Item bucket = null;
	private FlowingFluid flowing = null;
	private FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public OilBlock(MoreToolsElements instance) {
		super(instance, 123);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("more_tools:blocks/oilpsh"), new ResourceLocation("more_tools:blocks/oilflow1"))
						.luminosity(0).density(3000).viscosity(3000)).bucket(() -> bucket).block(() -> block);
