...
public class LateriteIngotItem extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:lateriteingot")
	public static final Item block = null;
	public LateriteIngotItem(MoreToolsElements instance) {
		super(instance, 30);
	}
