...
public class LateriteArmorItem extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:lateritearmorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("more_tools:lateritearmorbody")
	public static final Item body = null;
	@ObjectHolder("more_tools:lateritearmorlegs")
	public static final Item legs = null;
	@ObjectHolder("more_tools:lateritearmorboots")
	public static final Item boots = null;
	public LateriteArmorItem(MoreToolsElements instance) {
		super(instance, 44);
	}
