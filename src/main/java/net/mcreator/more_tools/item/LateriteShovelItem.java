...
public class LateriteShovelItem extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:lateriteshovel")
	public static final Item block = null;
	public LateriteShovelItem(MoreToolsElements instance) {
		super(instance, 37);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("lateriteshovel"));
	}
}
