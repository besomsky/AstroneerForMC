...
public class MalachiteIngotItem extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:copperingot")
	public static final Item block = null;
	public MalachiteIngotItem(MoreToolsElements instance) {
		super(instance, 3);
	}
