...
public class TungstenPickaxeItem extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:tungstenpickaxe")
	public static final Item block = null;
	public TungstenPickaxeItem(MoreToolsElements instance) {
		super(instance, 76);
	}
