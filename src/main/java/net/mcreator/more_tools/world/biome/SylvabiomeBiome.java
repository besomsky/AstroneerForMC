...
package net.mcreator.more_tools.world.biome;
...
import net.mcreator.more_tools.entity.LuisEntity;
...
public class SylvabiomeBiome extends MoreToolsElements.ModElement {
	@ObjectHolder("more_tools:sylvabiome")
	public static final CustomBiome biome = null;
	public SylvabiomeBiome(MoreToolsElements instance) {
		super(instance, 93);
	}
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			super(new Biome.Builder().downfall(0.5f).depth(0.1f).scale(0.2f).temperature(0.5f).precipitation(Biome.RainType.RAIN)
					.category(Biome.Category.NONE).waterColor(-15802464).waterFogColor(-15802464)
					.surfaceBuilder(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(),
							Blocks.COARSE_DIRT.getDefaultState(), Blocks.COARSE_DIRT.getDefaultState())));
			setRegistryName("sylvabiome");
			...
			this.addSpawn(EntityClassification.CREATURE, new Biome.SpawnListEntry(LuisEntity.entity, 15, 1, 5));
		}
